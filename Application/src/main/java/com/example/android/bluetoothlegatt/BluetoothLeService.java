...
public class BluetoothLeService extends Service {
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if(SerialPortAssistant.TX_CHAR_UUID.equals(characteristic.getUuid())){
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
            descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
            mBluetoothGatt.writeDescriptor(descriptor);
            ...
            if(BluetoothLeService.ACTION_GATT_HANDLE.equals(action)){
                switch (cmd){
                    ...
                    case R.integer.nordic_ble_nus_write_characteristic:
                        ...
                        characteristic = mBluetoothGatt.getService(SerialPortAssistant.NUS_SERVICE_UUID).getCharacteristic(SerialPortAssistant.RX_CHAR_UUID);
                        Log.i(TAG,data);
